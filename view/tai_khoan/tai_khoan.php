<div <?php echo isset($_SESSION['tai_khoan']) ? "hidden" : "" ?> class="border-2">
    ...
    <div class="py-4 px-5">
        <form action="index.php?url=login" method="post">
            ...
            <br>
            <br>
            <button class="border-2 py-2 px-2 hover:bg-slate-200" type="submit" name="btn_login">
                Đăng nhập
            </button>
            <br><br>
            <ul class="px-5">
                <li class="list-disc text-blue-500 hover:text-green-700">
                    <a href="index.php?url=sigup">đăng kí thành viên</a>
                </li>
            </ul>
        </form>
    </div>
